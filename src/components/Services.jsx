    ...
    <div>
      <div className="max-w-[1500px] mx-auto ">
        <div className="bg-gray-100 py-20">
          ...
          <h1 className="text-gray-950 dark:text-white text-center text-2xl md:text-4xl font-bold max-w-[70%] mx-auto py-8">
            {data.mainHeading}
          </h1>
          <div className="flex justify-center flex-col md:flex-row gap-20 max-w-[90%] mx-10 md:mx-20">
            {data.services.map((service, index) => (
              ...
              >
                ...
                <h4 className="text-[20px] font-bold my-3 cursor-pointer hover:text-amber-600">
                  {service.title}
                </h4>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-20">
            {serviceItems.map((item, index) => (
              <div key={index} className="group flex items-start gap-4 ">
                ...
                <div>
                  <h3 className="font-bold text-[16px] group-hover:text-amber-600">
                    {item.title}
                  </h3>
