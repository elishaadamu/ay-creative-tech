  ...
  return (
    <div className="w-full rounded-2xl mb-5 bg-white p-5 shadow-lg">
      ...
      >
        ...
        >
          <Select size="large" placeholder="Select  Validation type">
            <Select.Option value="No Record Found">
              No Record Found
            </Select.Option>
            <Select.Option value="Photograph Error">
              Photograph Error
            </Select.Option>
            <Select.Option value="Modification Validation">
              Modification Validation
            </Select.Option>
            <Select.Option value="Bank Validation">
              Bank Validation
            </Select.Option>
            <Select.Option value="Sim Validation">Sim Validation</Select.Option>
          </Select>
        </Form.Item>
